...
interface AddTodoProps {
    handleChangeFormTodo : (event : React.ChangeEvent<HTMLInputElement>) => void
    formTodo : Todo
}
        ...
        <>
            <div className="py-vertical">
                <div className="flex items-start gap-3">
                    <div className="flex gap-3 flex-1">
                        ...
                        <div className="rounded-md">
                            <input type="text" name="title" onChange={handleChangeFormTodo} placeholder="Type Task Title" className="w-full border-[1px] border-primary-gray px-2 py-1 rounded-md text-primary-black placeholder:text-primary-black" />
                        </div>
                    </div>
                ...
                <div className="flex items-start gap-6 mx-vertical mt-4 w-full">
                    <PencilIcon color={formTodo.description === '' ? '#4F4F4F' : '#2F80ED'}/>
